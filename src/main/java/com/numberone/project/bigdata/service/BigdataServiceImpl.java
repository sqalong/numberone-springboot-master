...
public class BigdataServiceImpl implements IBigdataService
{
     ...
     */
    @Override
    public Bigdata selectConfigById(Long configId)
    {
        Bigdata config = new Bigdata();
    ...
    public String selectConfigByKey(String configKey)
    {
        ...
        Bigdata retConfig = configMapper.selectConfig(config);
     ...
     */
    @Override
    public String checkConfigKeyUnique(Bigdata config)
    {
        Long configId = StringUtils.isNull(config.getConfigId()) ? -1L : config.getConfigId();
        Bigdata info = configMapper.checkConfigKeyUnique(config.getConfigKey());
